...
@rx.page(route="/profile", title="RDE Simulateur")
def profile_page():
    return rx.el.div(
        rx.image(
        ...
        rx.el.div(
            rx.el.div(
                rx.heading("Profil utilisateur", size="5", margin_bottom="16px"),
                rx.form(
                    rx.vstack(
                        rx.input(
                            default_value=AuthState.connected_user,
                            name="email",
                            placeholder="Email",
                            disabled=True,
                            label="Email",
                        ...
                        rx.button(
                            ...
                            type="submit",
                            size="4",
                            style={"box_shadow": "0 8px 20px rgba(0, 0, 0, 0.15)"},
                            margin="1em",
                        ),
                    ),
